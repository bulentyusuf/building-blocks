...
export default async function PostPage({
  ...
  return (
    ...
    >
      ...
      >
        {post.coverImage && (
          // mb-8 balances the gap above the mobile TOC pill against the
          // aside's mb-8 below it. xl:mb-10 is the original desktop value,
          // unrelated to the pill — the pill only exists below xl.
